...
class HomePostCell: UICollectionViewCell {
    ...
    var post: Post? {
        didSet {
            ...
            userProfileImageView.loadImageView(urlString: profileImageUrl)
        }
    }
    ...
    let captionLabel: UILabel = {
        let label = UILabel()
        let attributedText = NSMutableAttributedString(string: "Username ", attributes: [NSMutableAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14), NSAttributedString.Key.foregroundColor: UIColor.black])
        
        attributedText.append(NSAttributedString(string: "#nature #life #love", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14)]))
    ...
    override init(frame: CGRect) {
        ...
        usernameLabel.anchor(top: topAnchor, left: userProfileImageView.rightAnchor, bottom: photoImageView.topAnchor, right: optionsButton.leftAnchor, paddingTop: 0, paddingLeft: 8, paddingBotton: 0, paddingRight: 0, width: 0, height: 0)
    ...
    fileprivate func setupActionButtons() {
        ...
        bookmarkButton.anchor(top: photoImageView.bottomAnchor, left: nil, bottom: nil
            , right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBotton: 0, paddingRight: 0, width: 40, height: 50)
    }
